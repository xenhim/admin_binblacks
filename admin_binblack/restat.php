...
{
    //SELLER//
    $sql = "SELECT userId, username, paids FROM " . $config['table_users'] . " WHERE typeId = '3'";
    ...
    ///HEAD///
    $head = $twig->render('admin/seller/dumpandcard.tpl', array('listseller' => $listseller, 'type' => 'head'));
    ...
    foreach ($listseller as $seller)
    {
        ...
        //UNUSED CC//
        $sql = "SELECT cardId from " . $config["table_cards"] . " WHERE seller = '" . $seller[userId] . "' AND cardUsed = '0'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //UNUSED DUMPS//
        $sql = "SELECT dumpId from " . $config["table_dumps"] . " WHERE seller = '" . $seller[userId] . "' AND dumpUsed = '0'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //CHECKER LIVE//
        $sql = "SELECT cardId from " . $config["table_cards"] . " WHERE seller = '" . $seller[userId] . "' AND status = '1' AND cardUsed <> '0'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //CHECKER DUMP LIVE//
        $sql = "SELECT dumpId from " . $config["table_dumps"] . " WHERE seller = '" . $seller[userId] . "' AND status = '1' AND dumpUsed <> '0'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //CHECKER DUMP DIE//
        $sql = "SELECT dumpId from " . $config["table_dumps"] . " WHERE seller = '" . $seller[userId] . "' AND status = '2'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //CHECKER DIE//
        $sql = "SELECT cardId from " . $config["table_cards"] . " WHERE seller = '" . $seller[userId] . "' AND status = '2'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //CHECKER ERROR//
        $sql = "SELECT cardId from " . $config["table_cards"] . " WHERE seller = '" . $seller[userId] . "' AND status = '3'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //CHECKER DUMP ERROR//
        $sql = "SELECT dumpId from " . $config["table_dumps"] . " WHERE seller = '" . $seller[userId] . "' AND status = '3'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //CHECKER TIMEOFF//
        $sql = "SELECT cardId from " . $config["table_cards"] . " WHERE seller = '" . $seller[userId] . "' AND status = '5'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        $sql = "SELECT dumpId from " . $config["table_dumps"] . " WHERE seller = '" . $seller[userId] . "' AND status = '5'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //CHECKER UNKNOWN//
        $sql = "SELECT cardId from " . $config["table_cards"] . " WHERE seller = '" . $seller[userId] . "' AND status = '4'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        $sql = "SELECT dumpId from " . $config["table_dumps"] . " WHERE seller = '" . $seller[userId] . "' AND status = '4'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //fullsalespaid//
        $sql = "SELECT price, sellerprc from " . $config["table_cards"] . " WHERE seller = '" . $seller[userId] . "' AND cardUsed <> '0' AND (status = '1' OR status = '5')";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //fullsalespaid DUMP//
        $sql = "SELECT price, sellerprc from " . $config["table_dumps"] . " WHERE seller = '" . $seller[userId] . "' AND dumpUsed <> '0' AND (status = '1' OR status = '5')";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //fullsales//
        $sql = "SELECT cardId, cardNum, status, price, sellerprc from " . $config["table_cards"] . " WHERE seller = '" . $seller[userId] . "' AND cardUsed <> '0'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        //fullsales Dump//
        $sql = "SELECT dumpId, dumpNum, status, price, pack, sellerprc from " . $config["table_dumps"] . " WHERE seller = '" . $seller[userId] . "' AND dumpUsed <> '0'";
        $result = mysql_query($sql, $data_sql);
        if (!$result)
        {
            echo sql_error();
        ...
        $chartdumps->setChartAttrs(array(
            ...
            'size' => array(350, 250),
            'color' => $color2));
        $table .= $twig->render('admin/seller/dumpandcard.tpl', array(
            'type' => 'table',
            'seller' => $seller,
            'balance' => $balance,
            'earned' => $earned,
    ...
    $footer = $twig->render('admin/seller/dumpandcard.tpl', array('type' => 'footer'));
    echo $head;
    echo $table;
    echo $footer;
