<div class='page-header'><h1>My Dumps <small>checking</small></h1></div></div></div><table class='table table-striped table-bordered table-hover'>
...
{% if card.status == '0' %}
<a href='#' class='checkdump' item_id='{{card.dumpId}}' onclick="dumpchecki('{{card.dumpId}}')"><span class='label label-info'>CHECK</span></a>
{% endif %}
{% if card.status == '1' %}
