...
<option {% if showused == 'no' %} selected {% endif %} value="no">Unused</option>
<option {% if showused == 'yes' %} selected {% endif %} value="yes">Used</option>
<option {% if showused == 'all' %} selected {% endif %} value="all">All</option>
