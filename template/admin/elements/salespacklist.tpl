<div class='page-header'><h1>Sales Packs <small> open</small></h1></div></div></div><table class='table table-striped table-bordered table-hover'>
<tr><td><b>Id</b></td><td><b>Name</b></td><td><b>Category</b></td><td><b>Type</b></td><td><b>Level</b></td><td><b>Class</b><td><b>Code</b></td><td><b>Counry</b></td><td><b>Quantity</b></td><td><b>Used by</b></td></td><td><b>Date</b></td><td>Action</td></tr>
...
<td class='tdCol' style='font-size:12px;'><center>
<span class='badge'>{{card.username}}</span>
</center></td>
<td class='tdCol' style='font-size:12px;'><center>
{{card.sdate}}
</center></td>
<td class='tdCol' style='font-size:12px;'><center>
<a type="button" onclick="showpage('salepacks.php?act=open&id={{card.id}}');" class="btn btn-success">Open</a>
</center></td></tr>
{% endfor %}
{% else %}
