<div class="page-header"><h1>Dump Category<small>edit</small></h1></div></div></div>
<center><div class='panel panel-default' style='width:650px'><div class='panel-heading'>Category Edit</div>
<form action='dumpcategory.php?act=edit' method='POST' target='result'><table class='table table-bordered table-striped'>
